      ...
      <div className={styles.delivery__container}>
        <div className={styles.delivery__header}>
          <h2 className={styles.delivery__title}>
            {mainPageData?.delivery_title || "Доставка"}
          </h2>
        ...
        <div className={styles.delivery__slider_controls}>
          ...
          <div className={styles.delivery__progress}>
            <div
              ...
              style={{
                left: `${(activeTextIndex / (deliveryTexts.length - 1)) * 80}%`,
              }}
            ></div>
          </div>
        ...
        <div className={styles.delivery__blocks}>
          <div className={styles.delivery__block}>
            ...
            <p className={styles.delivery__block_text}>
              {mainPageData?.delivery_image_block_text1 ||
                "Самовывоз со склада или магазина — бесплатно!"}
            </p>
          </div>
          ...
          <div className={styles.delivery__block}>
            ...
            <h3 className={styles.delivery__block_title}>
              {mainPageData?.delivery_image_block_title2 ||
                "Курьерская доставка"}
            </h3>
            <p className={styles.delivery__block_text}>
              {mainPageData?.delivery_image_block_text2 ||
                "Доставка по всей России — срок и стоимость зависят от региона"}
            </p>
          </div>
          ...
          <div className={styles.delivery__block}>
            ...
            <p className={styles.delivery__block_text}>
              {mainPageData?.delivery_image_block_text3 ||
                "Предлагаем сборку мебели — быстро и качественно"}
            </p>
          </div>
        </div>
      </div>
