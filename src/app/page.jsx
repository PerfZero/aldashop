          ...
          <div className={styles.section__container}>
            <div className={styles.section__row}>
              <div className={styles.section__image}>
                ...
                <Link href={mainPageData?.main_page_items?.[1]?.product_id ? `/product/${mainPageData.main_page_items[1].product_id}` : "/products"} className={styles.section__button}>
            ...
            <div className={styles.section__row}>
              ...
              <Link href={mainPageData?.main_page_items?.[2]?.product_id ? `/product/${mainPageData.main_page_items[2].product_id}` : "/products"} className={styles.section__button}>
